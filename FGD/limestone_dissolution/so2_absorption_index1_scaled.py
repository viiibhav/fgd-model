# -*- coding: utf-8 -*-
"""
Created on Mon Oct 21 13:26:23 2019
...
from pyomo.environ import (ConcreteModel, Set, Param, Var,
                           ...
                           TransformationFactory, minimize)
...
m.c = Var(m.i, m.x, initialize=1e-05)
...
def _reform_con(m, i, x):
    if i in diff_vars:
        if x == 0:  # r for symmetry condition at the center
...
# Can be before or after solve:
m.write(filename="so2_abs_index1.nl", format=ProblemFormat.nl,
