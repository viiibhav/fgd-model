# -*- coding: utf-8 -*-
"""
Created on Thu Jan 30 15:26:10 2020
...
"""
Dynamic droplet model -- Brogren and Karlsson (1997)
...
eq_i = ["SO2", "HSO3-", "HCO3-", "CaSO3", "CaSO4", "CaCO3", "CaHCO3+"]
#assert set(eq_i).issubset(i)
m.eq_i = Set(initialize=eq_i)

alg_vars = ["SO2", "Ca2+", "OH-", "SO32-", "SO42-", "HSO3-", "HCO3-", "CO32-"]
